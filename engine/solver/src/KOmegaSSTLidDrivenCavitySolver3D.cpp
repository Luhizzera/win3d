...
double KOmegaSSTLidDrivenCavitySolver3D::u(std::size_t i, std::size_t j, std::size_t k) const {
    return u_[indexU(i, j, k)];
}
double KOmegaSSTLidDrivenCavitySolver3D::v(std::size_t i, std::size_t j, std::size_t k) const {
    return v_[indexV(i, j, k)];
}
double KOmegaSSTLidDrivenCavitySolver3D::w(std::size_t i, std::size_t j, std::size_t k) const {
    return w_[indexW(i, j, k)];
}
double KOmegaSSTLidDrivenCavitySolver3D::pressure(std::size_t i, std::size_t j, std::size_t k) const {
...
double KOmegaSSTLidDrivenCavitySolver3D::lidVelocityAt(double x, double y) const {
...
double KOmegaSSTLidDrivenCavitySolver3D::wallDistanceAt(std::size_t i, std::size_t j, std::size_t k) const {
...
double KOmegaSSTLidDrivenCavitySolver3D::stableTimeStep() const {
    double maxNut = 0.0;
    for (double n : nut_) {
...
double KOmegaSSTLidDrivenCavitySolver3D::uAt(long long i, long long j, long long k) const {
...
double KOmegaSSTLidDrivenCavitySolver3D::vAt(long long i, long long j, long long k) const {
...
double KOmegaSSTLidDrivenCavitySolver3D::wAt(long long i, long long j, long long k) const {
...
double KOmegaSSTLidDrivenCavitySolver3D::pAt(long long i, long long j, long long k) const {
    long long ci = i;
    long long cj = j;
    long long ck = k;
    if (ci < 0) {
...
double KOmegaSSTLidDrivenCavitySolver3D::nutAt(long long i, long long j, long long k) const {
...
double KOmegaSSTLidDrivenCavitySolver3D::maxDivergence() const {
    double maxDiv = 0.0;
    for (std::size_t k = 0; k < nz_; ++k) {
        for (std::size_t j = 0; j < ny_; ++j) {
            for (std::size_t i = 0; i < nx_; ++i) {
...
std::vector<double> KOmegaSSTLidDrivenCavitySolver3D::applyLaplacian(const std::vector<double>& x) const {
...
double KOmegaSSTLidDrivenCavitySolver3D::dot(const std::vector<double>& a, const std::vector<double>& b) {
    double result = 0.0;
...
void KOmegaSSTLidDrivenCavitySolver3D::projectToDivergenceFree(std::vector<double>& uStar,
